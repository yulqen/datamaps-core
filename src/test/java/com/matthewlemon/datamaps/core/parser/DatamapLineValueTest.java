...
public class DatamapLineValueTest {
	...
	public void valueObjectText() {
		DatamapLineValue<String> value1 = new DatamapLineValue<String>("Test Value 1");
		DatamapLineValue<String> value2 = new DatamapLineValue<String>("Test Value 2");
		DatamapLineValue<String> value3 = new DatamapLineValue<String>("Test Value 1");
	...
	public void valueObjectNumeric() {
		DatamapLineValue<Double> value1 = new DatamapLineValue<Double>(20.1);
		DatamapLineValue<Double> value2 = new DatamapLineValue<Double>(25.1);
		DatamapLineValue<Double> value3 = new DatamapLineValue<Double>(20.1);
